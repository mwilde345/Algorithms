    ...
    <div class="panel-body">
      ...
      <div class="tab-content clearfix">
        <div class="tab-pane active" id="1">
          <?php include("./week6.1.php"); ?>
        </div>
        <div class="tab-pane" id="2">
          <?php include("./week6.2.php"); ?>
        </div>
        <div class="tab-pane" id="3">
          <?php include("./week6.3.php"); ?>
        </div>
        <div class="tab-pane" id="4">
          <?php include("./week6.4.php"); ?>
        </div>
        <div class="tab-pane" id="5">
          <?php include("./week6.5.php"); ?>
        </div>
        <div class="tab-pane" id="6">
          <?php include("./week6.6.php"); ?>
        </div>
        <div class="tab-pane" id="7">
          <?php include("./week6.7.php"); ?>
        </div>
        <div class="tab-pane" id="8">
          <?php include("./week6.8.php"); ?>
        </div>
        <div class="tab-pane" id="9">
          <?php include("./week6.9.php"); ?>
        </div>
      </div>
    </div>
  </div>
