    ...
    <div class="panel-body">
      ...
      <div class="tab-content clearfix">
        <div class="tab-pane active" id="1">
          <?php include("./week2.1.php"); ?>
        </div>
        <div class="tab-pane" id="2">
          <?php include("./week2.2.php"); ?>
        </div>
        <div class="tab-pane" id="3">
          <?php include("./week2.3.php"); ?>
        </div>
        <div class="tab-pane" id="4">
          <?php include("./week2.4.php"); ?>
        </div>
        <div class="tab-pane" id="5">
          <?php include("./week2.5.php"); ?>
        </div>
        <div class="tab-pane" id="6">
          <?php include("./week2.6.php"); ?>
        </div>
        <div class="tab-pane" id="7">
          <?php include("./week2.7.php"); ?>
        </div>
        <div class="tab-pane" id="8">
          <?php include("./week2.8.php"); ?>
        </div>
        <div class="tab-pane" id="9">
          <?php include("./week2.9.php"); ?>
        </div>
        <div class="tab-pane" id="10">
          <?php include("./week2.10.php"); ?>
        </div>
        <div class="tab-pane" id="11">
          <?php include("./week2.11.php"); ?>
        </div>
      </div>
    </div>
  </div>
