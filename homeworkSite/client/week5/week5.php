  ...
  <div class="panel panel-default">
    <div class="panel-body">
      <ul class="nav nav-tabs">
        ...
        <li role="presentation"><a data-toggle="tab" href="#11"><button type="button" class="btn btn-primary">11</button></a></li>
        <li role="presentation"><a data-toggle="tab" href="#12"><button type="button" class="btn btn-primary">12</button></a></li>
      </ul>
      <div class="tab-content clearfix">
        <div class="tab-pane active" id="1">
          <?php include("./week5.1.php"); ?>
        </div>
        <div class="tab-pane" id="2">
          <?php include("./week5.2.php"); ?>
        </div>
        <div class="tab-pane" id="3">
          <?php include("./week5.3.php"); ?>
        </div>
        <div class="tab-pane" id="4">
          <?php include("./week5.4.php"); ?>
        </div>
        <div class="tab-pane" id="5">
          <?php include("./week5.5.php"); ?>
        </div>
        <div class="tab-pane" id="6">
          <?php include("./week5.6.php"); ?>
        </div>
        <div class="tab-pane" id="7">
          <?php include("./week5.7.php"); ?>
        </div>
        <div class="tab-pane" id="8">
          <?php include("./week5.8.php"); ?>
        </div>
        <div class="tab-pane" id="9">
          <?php include("./week5.9.php"); ?>
        </div>
        <div class="tab-pane" id="10">
          <?php include("./week5.10.php"); ?>
        </div>
        <div class="tab-pane" id="11">
          <?php include("./week5.11.php"); ?>
        </div>
        <div class="tab-pane" id="12">
          <?php include("./week5.12.php"); ?>
        </div>
      </div>
    </div>
  </div>
